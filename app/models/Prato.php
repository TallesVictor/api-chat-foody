...
class Prato extends Model
{
    ...
    public function listItens($id)
    {
        ...
        $prato = "SELECT p.nome, p.preco as valor, p.url, r.razao_social restaurante, r.rua, r.numero, r.cidade, r.estado  FROM prato p JOIN cardapio c ON c.id= p.cardapio_id JOIN restaurante r ON r.id = c.restaurante_id WHERE p.id=?";
