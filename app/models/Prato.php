...
class Prato extends Model
{
    ...
    public function create(Request $request)
    {
        ...
        $prato->ingredientes = array_slice($request->ingredientes, 0, 3) ;
    ...
    public function listItens($id)
    {
        ...
        $prato = "SELECT p.nome, p.preco as valor, p.url, r.razao_social restaurante, CONCAT(r.rua,'-', r.numero, ', ', r.cidade,'/', r.estado) endereco  FROM prato p JOIN cardapio c ON c.id= p.cardapio_id JOIN restaurante r ON r.id = c.restaurante_id WHERE p.id=?";
